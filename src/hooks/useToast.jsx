...
function ToastItem({ toast, onClose }) {
  ...
  const STYLES = {
    success: {
      bg: 'linear-gradient(135deg, #202124 0%, #25272a 100%)',
      border: 'rgba(184, 160, 106, 0.4)',
      color: '#b8a06a',
      iconBg: 'rgba(184, 160, 106, 0.15)',
      icon: (
    ...
    error: {
      bg: 'linear-gradient(135deg, #202124 0%, #1f0f15 100%)',
...
function ConfirmDialog({ opts, onResolve }) {
  const TYPE = {
    ...
    warning: {
      iconBg: 'rgba(184, 160, 106, 0.15)',
      iconColor: '#b8a06a',
      btnBg: 'linear-gradient(135deg, #b8a06a 0%, #8f7a45 100%)',
      btnColor: '#111214',
      btnShadow: '0 6px 24px rgba(184,160,106,.35)',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
          <circle cx="12" cy="12" r="10" />
    ...
    info: {
      iconBg: 'rgba(184, 160, 106, 0.15)',
      iconColor: '#b8a06a',
      btnBg: 'linear-gradient(135deg, #b8a06a 0%, #7af5f8 100%)',
      btnColor: '#111214',
      ...
      >
        ...
        <div style={{ display: 'flex', gap: '.6rem', justifyContent: 'stretch' }}>
          <button
            ...
            onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(132,153,194,0.2)'; e.currentTarget.style.color = '#8f9499' }}
          >
