...
//         borderRadius: '12px',
//       }}>
//         <p className="font-body font-bold text-xs uppercase tracking-widest mb-3" style={{ color: '#6f7377' }}>
//           {label}
//         </p>
//         <input
//           type="text"
...
//         }}
//         onMouseEnter={(e) => {
//           e.target.style.background = '#b8a06a'
//           e.target.style.color = '#1f2023'
//         }}
//         onMouseLeave={(e) => {
//           e.target.style.background = '#dedbd4'
//           e.target.style.color = '#6f7377'
//         }}
//       >
//         + Otro equipo
//       </button>
...
//               }}
//               onMouseEnter={e => {
//                 if (!checked) e.currentTarget.style.background = 'rgba(184,160,106,0.04)'
//               }}
//               onMouseLeave={e => {
...
//               <span className="font-body text-sm" style={{ color: '#1f2023', flex: 1 }}>
//                 {nombre}
//               </span>
...
//           <label className="font-body font-bold text-xs uppercase tracking-widest" style={{ color: '#6f7377' }}>
//             Competición
//           </label>
//         </div>
...
//             />
//             <div>
//               <p className="font-body font-bold text-sm" style={{ color: '#1f2023', margin: 0 }}>
//                 {form.competicion}
//               </p>
//               <p className="font-body text-xs" style={{ color: '#a9adb1', margin: '4px 0 0 0' }}>
//                 Click para cambiar
//               </p>
//             </div>
//           </div>
...
//             <div style={{
//               padding: '12px 16px',
//               background: 'linear-gradient(135deg, #1f2023 0%, #2c2e31 100%)',
//               borderBottom: '1px solid rgba(184,160,106,0.15)',
//               display: 'flex',
//               justifyContent: 'space-between',
//               alignItems: 'center',
//             }}>
//               <span className="font-body font-bold text-xs uppercase tracking-widest" style={{ color: '#b8a06a' }}>
//                 Matchup {idx + 1}
//               </span>
...
//                         onError={(e) => e.target.src = ESCUDO_GRIS}
//                       />
//                       <span className="font-body text-sm font-semibold" style={{ color: '#1f2023' }}>
//                         {matchup.equipo1_nombre}
//                       </span>
//                     </div>
//                   ) : (
