...
function getBetStatus(bet) {
  ...
  return { color: '#6f7377', bg: 'rgba(95,110,138,.06)', border: 'rgba(95,110,138,.12)', label: bet.estado || '—', dot: false }
}
...
>
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="font-display text-2xl" style={{ color: '#202124', letterSpacing: '.02em' }}>NUEVA APUESTA</h2>
        </div>
      ...
      <div className="flex flex-col gap-5 w-full">
        ...
        {loading && bets.length === 0 && (
          <div className="text-center py-16">
            ...
            <p className="font-body text-sm mt-3" style={{ color: '#6f7377' }}>Cargando apuestas...</p>
          </div>
        )}
        ...
        {!loading && bets.length === 0 && (
          <div className="rounded-2xl p-12 text-center" style={{ background: '#fff', border: '1px dashed #d8d5ce' }}>
            ...
            <p className="font-body text-sm font-semibold" style={{ color: '#6f7377' }}>Todavía no creaste apuestas.</p>
            <p className="font-body text-xs mt-1" style={{ color: '#a9adb1' }}>Usá el formulario para crear la primera.</p>
          </div>
        )}
