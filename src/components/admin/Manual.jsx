    ...
    <div style={{ marginBottom:30, position:'relative' }}>
      ...
      <div style={{ position:'relative', zIndex:1, paddingTop:14 }}>
        ...
        <div style={{ display:'flex', alignItems:'flex-start', gap:14 }}>
          {icon && (
            <div style={{
              ...
              boxShadow:'0 6px 18px rgba(32,33,36,.18)',
              marginTop:4,
            }}>{icon}</div>
          )}
          <h2 style={{
        ...
        <div style={{
          ...
          background:`linear-gradient(90deg,${C.gold} 0%,rgba(184,160,106,.4) 30%,rgba(184,160,106,0) 80%)`,
        }}/>
      </div>
    </div>
  )
...
function Step({ num, title, children }) {
  return (
    <div style={{
      ...
      onMouseEnter={e=>{ e.currentTarget.style.borderColor='rgba(184,160,106,.5)'; e.currentTarget.style.transform='translateX(3px)'; e.currentTarget.style.boxShadow='0 4px 14px rgba(32,33,36,.06)' }}
      ...
      <div style={{
        ...
        boxShadow:'0 4px 10px rgba(32,33,36,.18)',
      }}>{num}</div>
      <div style={{ flex:1 }}>
        <p style={{
          fontFamily:"'DM Sans',sans-serif", fontWeight:700,
...
function PhaseCard({ tag, tagColor, name, desc, matches, accent=C.gold }) {
  return (
    <div style={{
      ...
      onMouseEnter={e=>{ e.currentTarget.style.borderColor=accent; e.currentTarget.style.transform='translateY(-3px)'; e.currentTarget.style.boxShadow=`0 14px 32px rgba(32,33,36,.1), 0 0 0 1px ${accent}33` }}
      onMouseLeave={e=>{ e.currentTarget.style.borderColor=C.cream2; e.currentTarget.style.transform='none'; e.currentTarget.style.boxShadow='none' }}>
  ...
  if (variant==='solid') {
    return (
      <button onClick={onClick} style={{
        ...
        boxShadow:'0 6px 18px rgba(184,160,106,.35)',
        transition:'all .18s ease',
      }}
        onMouseEnter={e=>{ e.currentTarget.style.background=C.goldLt; e.currentTarget.style.transform='translateY(-1px)'; e.currentTarget.style.boxShadow='0 8px 22px rgba(184,160,106,.5)' }}
        onMouseLeave={e=>{ e.currentTarget.style.background=C.gold; e.currentTarget.style.transform='none'; e.currentTarget.style.boxShadow='0 6px 18px rgba(184,160,106,.35)' }}>
        {children}
                ...
                {SECTIONS.filter(s=>s.group===group).map(s=>{
                  ...
                  return (
                    <button key={s.id} onClick={()=>goTo(s.id)} style={{
                      ...
                      background:active?'rgba(184,160,106,.1)':'transparent',
                      border:'none',
                      ...
                      onMouseEnter={e=>{ if(!active){ e.currentTarget.style.background='rgba(184,160,106,.05)' }}}
        ...
        <main ref={contentRef} style={{
          ...
          <section id="manual-checklist" style={{ marginBottom:48, scrollMarginTop:24 }}>
            ...
            <div style={{
              ...
              boxShadow:'0 18px 48px rgba(32,33,36,.25)',
            }}>
              {/* Glow decorativo */}
              <div style={{
                position:'absolute', top:-60, right:-80,
                width:280, height:280,
                background:'radial-gradient(circle,rgba(184,160,106,.18),transparent 65%)',
                pointerEvents:'none',
              }}/>
              <div style={{ position:'relative' }}>
                <span style={{
                ...
                <div style={{
                  ...
                  {[
                    ...
                    <div key={i} style={{
                      display:'flex', alignItems:'center', gap:10,
                      padding:'8px 12px',
                      background:'rgba(184,160,106,.06)',
              ...
              <div style={{ display:'flex', flexWrap:'wrap', gap:8 }}>
                {[
                  ...
                  <button key={path} onClick={()=>navigate(path)}
                    ...
                    onMouseEnter={e=>{ e.currentTarget.style.borderColor=C.gold; e.currentTarget.style.background='rgba(184,160,106,.08)'; e.currentTarget.style.color=C.goldDk }}
