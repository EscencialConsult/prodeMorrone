...
export default function PredictModal({ bet, onSubmit, onClose, loading }) {
  ...
  if (estaBloqueado) {
    if (!esJefe) {
      razonBloqueo = {
        ...
        detalle: 'Este pronóstico es grupal: cada área compite como equipo y las predicciones las carga únicamente el jefe. Podés ver los partidos pero no modificar el marcador.',
      }
    } else if (!miAreaParticipa) {
      razonBloqueo = {
        titulo: 'Tu área no participa en este pronóstico',
        detalle: 'Este pronóstico grupal está reservado a otras áreas de la empresa. Podés ver los partidos pero no cargar predicciones.',
      }
    }
  }
  ...
  // âœ… FUNCIÃ“N SIMPLIFICADA QUE SÍ FUNCIONA
  const cerrarModal = () => {
    console.log('ðŸ”´ CERRANDO MODAL') // Para debug
    onClose()
  }
          ...
          <div className="p-5 border-b border-white/10 flex-shrink-0">
            ...
            <div className="mt-3 text-[13px] text-slate-300 leading-relaxed">
              {open
                ...
                : 'El pronóstico está cerrado. Modo solo lectura.'}
            </div>
          </div>
        ...
        <div className="flex flex-col bg-white min-w-0 h-full overflow-hidden">
          ...
          <header className="px-4 sm:px-6 py-3 bg-gradient-to-r from-white to-amber-50/50 border-b border-slate-200 flex items-center justify-between gap-4 flex-shrink-0 shadow-sm">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              {/* âœ… BOTÃ“N X TOTALMENTE AISLADO */}
              <div 
          ...
          >
            ...
            {totalMatches === 0 && (
              <div className="flex flex-col items-center justify-center py-12 px-6 text-center">
                ...
                <p className="text-sm text-slate-500">Este pronóstico aún no tiene fixture cargado</p>
              </div>
            )}
