...
const STATE_STYLES = {
  ...
  abierta: {
    border: 'rgba(111,115,119,.6)',
    glow: '0 0 24px rgba(111,115,119,.15)',
    label: 'ABIERTA',
    color: '#7b9fd4',
    bg: 'rgba(111,115,119,.18)',
  },
  finalizada: {
    border: 'rgba(184,160,106,.35)',
    glow: '0 0 24px rgba(184,160,106,.08)',
    label: 'FINALIZADA',
    color: '#8f7a45',
    bg: 'rgba(184,160,106,.1)',
  },
  cerrada: {
...
/* â”€â”€ Ícono de reconocimiento (premio) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
/* â”€â”€ Ícono de reloj (countdown) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
/* â”€â”€ Bandera del equipo (con fallback si no hay imagen) â”€â”€â”€ */
...
/* â”€â”€ Badge genérico (tipo pill) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
export default function BetCard({ bet, predictionsMap, onPredict }) {
  ...
  // Estado visual de el pronóstico
  const state = isLive
    ? 'en_vivo'
    : allFinished
      ? 'finalizada'
  ...
  if (esGrupal && !esJefe && miAreaParticipa) {
    // General en grupal â†’ cambia el label
    actionLabel = hasAnyPrediction ? 'Ver predicciones del área' : 'Ver pronóstico'
  } else if (!open) {
  ...
  return (
    <div
      ...
      style={{
        background: 'linear-gradient(145deg, #25272a 0%, #0a1830 100%)',
      ...
      <div className="p-5 md:p-6">
        ...
        <div className="flex items-start justify-between gap-3 mb-4">
          ...
          <div className="flex flex-col items-end gap-1.5 flex-shrink-0">
            ...
            {/* Badge de tipo: GRUPAL / INDIVIDUAL â€” solo Plan_pro */}
            {isPro && (esGrupal ? (
              <Pill
        ...
        {soyGeneralSinPrediccion && open && (
          ...
          >
            ...
            <p className="text-xs font-body text-[var(--color-warn)] leading-relaxed">
              Tu referente todavía no cargó las predicciones del área. Recordáselo antes de que cierre el pronóstico.
            </p>
          </div>
        )}
          ...
          <button
            ...
            style={{
              background: open && (!esGrupal || esJefe)
                ...
                : 'transparent',
              color: open && (!esGrupal || esJefe) ? '#111214' : 'var(--color-accent)',
