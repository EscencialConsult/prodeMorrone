...
/* â”€â”€ Chip de filtro reutilizable â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
/* â”€â”€ Tarjeta de estadística â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
/* â”€â”€ Bandera â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
/* â”€â”€ Fila de partido dentro del acordeón â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
/* â”€â”€ Tarjeta de pronóstico (acordeón) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
/* â”€â”€ Página principal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
export default function MisPrediccionesPage() {
    ...
    useEffect(() => {
        async function cargar() {
            setLoading(true)
            try {
                const [pronósticosResp, partidosResp, prediccionesResp] = await Promise.all([
                ...
                const pronósticos = (pronósticosResp.pronósticos || []).map(a => {
    ...
    // Mapa por pronóstico: { pronósticoId: { partidoId: pred } }
    ...
    // Pronósticos en las que realmente tengo predicciones o puedo tener
    const misBets = useMemo(() => {
        return bets.filter(b => {
            const preds = predsPorApuesta[b.id] || {}
            const tieneAlgunaPred = Object.keys(preds).length > 0
            // Las pronósticos grupales donde participa mi área las incluimos aunque no tenga preds propias
    ...
    // Stats globales
    const stats = useMemo(() => {
        const totalPronosticos = misBets.length
        ...
        return { totalPronosticos, totalPreds, puntos, exactos }
        ...
        <AppLayout>
            ...
            <div className="mb-6 animate-fade-in">
                ...
                <p className="text-[var(--color-text-muted)] font-body text-sm">
                    Tu historial personal de pronósticos y aciertos
                </p>
            </div>

            {/* Stats dashboard */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6 animate-fade-in delay-1">
                <StatCard label="Pronósticos" value={stats.totalPronosticos} />
            ...
            {loading ? (
                ...
                >
                    ...
                    <p className="text-[var(--color-text-faint)] font-body text-xs">
                        {misBets.length === 0
                            ? 'Andá a "Pronósticos" y cargá tus primeras predicciones.'
