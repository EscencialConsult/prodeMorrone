        ...
        <div className="grid gap-4">
          ...
          {filtered.length === 0 && !loading && (
            ...
            >
              ...
              <p className="font-body font-semibold text-base mb-1" style={{ color: '#6f7377' }}>
                {filter === 'todas'
              ...
              <p className="font-body text-xs" style={{ color: '#a9adb1' }}>
                {filter === 'todas'
          ...
          {filtered.length === 0 && loading && (
            <div className="text-center py-16">
              <span className="inline-block w-8 h-8 border-2 border-t-transparent rounded-full animate-spin"
                style={{ borderColor: '#202124', borderTopColor: 'transparent' }} />
