...
.rk-detail-btn-podio {
  background:rgba(32,33,36,.06);color:#202124;
}
.rk-detail-btn-podio:hover:not(:disabled) { background:rgba(32,33,36,.12) }
.rk-detail-btn-podio.active { background:#202124;color:#b8a06a }

.rk-detail-btn-mini {
  background:rgba(32,33,36,.05);color:#6f7377;
  font-size:8px;padding:4px 8px;
}
.rk-detail-btn-mini:hover:not(:disabled) { background:rgba(32,33,36,.1);color:#202124 }
.rk-detail-btn-mini.active { background:#202124;color:#b8a06a }
      ...
      <div style={{ maxWidth:1400, margin:'0 auto', padding:'2rem 1.5rem 3rem' }}>
        ...
        <div className="rk-in" style={{ marginBottom:'1.5rem' }}>
          <h1 style={{
            ...
            <span style={{color:'#202124'}}>RANKING </span>
        ...
        <div className="rk-shell" style={{display:'flex',height:'calc(100vh - 200px)',minHeight:520,borderRadius:20,overflow:'hidden',boxShadow:'0 8px 48px rgba(32,33,36,.14)'}}>

          <div className="rk-sidebar">
            <div style={{padding:'20px 16px 14px',borderBottom:'1px solid #dedbd4'}}>
...
══════════════════════════════════════════ */
const PODIO_CFG = {
  0: { grad:'linear-gradient(145deg,#d6c08a 0%,#8f7a45 100%)', shadow:'rgba(184,160,106,.5)', border:'rgba(184,160,106,.7)', ring:'rgba(184,160,106,.3)', emoji:'🥇', label:'1°' },
...
function PrediccionesPanel({ user, predicciones, apuesta, onClose }) {
  return (
    <div className="rk-in" style={{
      ...
      padding:'1rem 1.2rem',
      marginBottom:20,
      boxShadow:'0 4px 20px rgba(32,33,36,.06)',
    }}>
      <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:'.9rem',paddingBottom:'.7rem',borderBottom:'1px solid #dedbd4'}}>
        <div>
          <p style={{fontSize:9,fontWeight:800,textTransform:'uppercase',letterSpacing:'.22em',color:'#94a3b8',margin:'0 0 3px'}}>
            Predicciones de
          </p>
          <p style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:18,color:'#202124',margin:0,letterSpacing:'.02em',lineHeight:1}}>
            {user?.nombre}
          </p>
        </div>
        <button
          ...
          onMouseEnter={e=>e.currentTarget.style.background='rgba(32,33,36,.12)'}
          onMouseLeave={e=>e.currentTarget.style.background='rgba(32,33,36,.06)'}
        >
      ...
      {predicciones.length > 0 ? (
        ...
        <p style={{fontSize:'.8rem',color:'#a9adb1',margin:0,textAlign:'center',padding:'.8rem 0'}}>
...
function PrediccionRow({ pred, apuesta }) {
  ...
  if (puntosDlBackend !== null) {
    ...
    if (puntosDlBackend === ptsExacto) {
      ...
      borderC='#b8a06a40'; bgC='#b8a06a0a'; badge={c:'#b8a06a',label:`+${puntosDlBackend}`}
      ...
      if (tieneResultado) {
        ...
        borderC='#dedbd4'; bgC='#fbfaf7'; badge=null
      }
    }
    ...
    else if (dif) { borderC='#b8a06a40'; bgC='#b8a06a0a'; badge={c:'#b8a06a',label:`+${ptsDif}`} }
  ...
  return (
    <div style={{
      ...
      <div style={{minWidth:0}}>
        <p style={{fontSize:'.78rem',fontWeight:600,color:'#202124',margin:'0 0 .12rem',overflow:'hidden',textOverflow:'ellipsis',whiteSpace:'nowrap'}}>
      ...
      <div style={{textAlign:'center'}}>
        ...
        <p style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:'1.05rem',fontWeight:700,color:'#202124',margin:0,letterSpacing:'.04em'}}>
      ...
      <div style={{textAlign:'center'}}>
        ...
        <p style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:'1.05rem',fontWeight:700,color:tieneResultado?'#202124':'#a9adb1',margin:0,letterSpacing:'.04em'}}>
...
function EmptySelect() {
  return (
    <div style={{height:'100%',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',padding:40,textAlign:'center',gap:20}}>
      ...
      <div>
        <p style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:22,color:'#202124',margin:'0 0 6px',letterSpacing:'.04em'}}>SELECCIONÁ UNA APUESTA</p>
    ...
    <div style={{marginTop:20}}>
      ...
      >
        <div style={{display:'flex',alignItems:'center',gap:8,flex:1}}>
          ...
          <span style={{fontSize:8,fontWeight:700,background:'rgba(32,33,36,.05)',color:'#c8c9cc',padding:'1px 6px',borderRadius:4}}>
            +{otros.length}
          </span>
          ...
          {otros.map((u, idx) => {
            ...
            return (
              <div key={u.user_id} style={{
                ...
                {isExpanded && (
                  <div style={{borderTop:'1px solid #dedbd4',padding:'.8rem 1rem',background:'#fbfaf7'}}>
                    {(predicciones[u.user_id] || []).length > 0 ? (
                      <PrediccionesGrid predicciones={predicciones[u.user_id]} apuesta={apuesta}/>
                    ) : (
                      <p style={{fontSize:'.7rem',color:'#a9adb1',margin:0,textAlign:'center'}}>Sin predicciones</p>
                    )}
                  </div>
                )}
              </div>
