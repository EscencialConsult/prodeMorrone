  ...
  return (
    <>
      ...
      >
        ...
        {/* â”€â”€ TOP: logo empresa + marca â”€â”€ */}
        <div className="relative z-10 flex flex-col items-center mb-6 text-center lp-card">
          {/* Slot logo cliente */}
          ...
          <div className="px-8 py-8">
            ...
            <div className="mb-7">
              ...
              <p className="font-body text-sm mt-1.5" style={{ color: 'rgba(255,255,255,.45)' }}>
                Ingresá para participar del prode interno de Estudio MRE.
              </p>
            </div>
