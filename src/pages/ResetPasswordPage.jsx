      ...
      >
        ...
        >
          ...
          <div className="px-8 py-8">
            ...
            {/* â”€â”€ Estado 1: Validando token â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
            {validando && (
            ...
            {/* â”€â”€ Estado 2: Token inválido o expirado â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
            {!validando && !tokenValido && (
              <div className="text-center py-2">
                ...
                <Link
                  ...
                  style={{ background: '#b8a06a', color: '#111214', boxShadow: '0 8px 28px rgba(184,160,106,.3)', textDecoration: 'none' }}
                  onMouseEnter={e => { e.currentTarget.style.background = '#d6c08a'; e.currentTarget.style.transform = 'translateY(-2px)' }}
            ...
            {/* â”€â”€ Estado 3: Token válido â†’ formulario â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
            {!validando && tokenValido && !done && (
              <>
                <div className="mb-7">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="font-body text-xs uppercase tracking-widest font-bold"
                      style={{ color: 'rgba(184,160,106,.7)' }}>
                      Nueva contraseña
                    </span>
                  </div>
                  ...
                  {userInfo && (
                    <p className="font-body text-sm mt-2" style={{ color: 'rgba(255,255,255,.45)' }}>
                      Hola <span style={{ color: '#b8a06a', fontWeight: 600 }}>{userInfo.nombre}</span>, elegí una contraseña nueva para tu cuenta.
                    </p>
                  )}
                </div>
                ...
                <div className="h-px mb-6"
                  style={{ background: 'linear-gradient(90deg, transparent, rgba(184,160,106,.2) 50%, transparent)' }} />
            ...
            {/* â”€â”€ Estado 4: Contraseña actualizada â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
            {done && (
              <div className="text-center py-2">
                <div
                  className="w-16 h-16 mx-auto mb-5 rounded-full flex items-center justify-center"
                  style={{
                    ...
                    border: '2px solid rgba(184,160,106,.45)',
                  }}
                >
