...
export default function AdminPage() {
  ...
  /* â”€â”€ Usuarios â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  ...
  /* â”€â”€ Áreas â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
/* â”€â”€ Efectos â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */

/* â”€â”€ Carga inicial â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
useEffect(() => {
...
useEffect(() => {
  ...
  /* â”€â”€ Funciones: Áreas â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  ...
  /* â”€â”€ Funciones: Usuarios â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
// âœ… MOSTRAR LOADING MIENTRAS CARGA DATOS INICIALES
if (initialLoading) {
    ...
    <AppShell>
      ...
      <div style={{ maxWidth: 1400, margin: '0 auto', padding: '2rem 1.5rem 3rem' }}>
        ...
        <div className="mb-6 h-px"
          style={{ background: 'linear-gradient(90deg,transparent,rgba(184,160,106,.25) 30%,rgba(184,160,106,.25) 70%,transparent)' }} />
...
/>
        ...
        {/* TAB 2: Pronósticos creados */}
        {tab === 'PronósticosCreadas' && (
<BetsListTab
  bets={bets}
  loading={betsLoading}
  closeBet={closeBet}
    ...
    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
      <div>
        <h2 className="font-display text-2xl md:text-3xl tracking-wide"
          style={{ color: '#1f2023', letterSpacing: '0.02em' }}>
          USUARIOS PENDIENTES
        </h2>
      ...
      <button
        ...
        style={{
          background: loadingUsers ? 'rgba(184,160,106,0.1)' : '#fff',
          border: '1.5px solid #dedbd4',
          color: loadingUsers ? '#8f7a45' : '#6f7377',
          boxShadow: '0 1px 0 rgba(31,32,35,0.03)',
        }}
        onMouseEnter={e => {
          if (!loadingUsers) {
            e.currentTarget.style.borderColor = '#b8a06a'
            e.currentTarget.style.color = '#8f7a45'
            e.currentTarget.style.transform = 'translateY(-1px)'
            e.currentTarget.style.boxShadow = '0 4px 12px rgba(184,160,106,0.15)'
          }
        }}
        onMouseLeave={e => {
          e.currentTarget.style.borderColor = '#dedbd4'
          e.currentTarget.style.color = '#6f7377'
          e.currentTarget.style.transform = 'translateY(0)'
          e.currentTarget.style.boxShadow = '0 1px 0 rgba(31,32,35,0.03)'
        }}
      >
        {loadingUsers ? (
          <>
    ...
    {loadingUsers && pendingUsers.length === 0 ? (
      <div className="text-center py-20">
        <span className="inline-block w-10 h-10 border-3 border-t-transparent rounded-full animate-spin"
          style={{ borderColor: '#b8a06a', borderTopColor: 'transparent' }} />
        <p className="font-body text-sm mt-4" style={{ color: '#6f7377' }}>
          Cargando usuarios...
        </p>
      </div>
    ) : pendingUsers.length === 0 ? (
      ...
      <div
        ...
        style={{
          background: '#fff',
          border: '1.5px dashed #dedbd4',
          boxShadow: '0 1px 0 rgba(31,32,35,0.03)',
        }}
      >
        <div className="w-16 h-16 mx-auto mb-5 rounded-2xl flex items-center justify-center"
          style={{ background: 'rgba(184,160,106,0.08)', border: '1px solid rgba(184,160,106,0.2)' }}>
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#8f7a45" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M20 6L9 17l-5-5" />
          </svg>
        </div>
        <p className="font-body font-semibold text-lg mb-2" style={{ color: '#1f2023' }}>
          Todo aprobado
        </p>
        <p className="font-body text-sm max-w-md mx-auto" style={{ color: '#6f7377' }}>
        ...
        {pendingUsers.map(u => {
          ...
          return (
            <div
              ...
              style={{
                background: '#fff',
                border: `1.5px solid ${isApproving ? '#b8a06a' : isRejecting ? '#ff4d6d' : '#dedbd4'}`,
                boxShadow: isApproving || isRejecting 
                  ? '0 8px 24px rgba(31,32,35,0.12)' 
                  : '0 1px 0 rgba(31,32,35,0.03)',
              }}
            >
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex items-center gap-4 min-w-0 flex-1">
                    ...
                    <div
                      ...
                      style={{
                        background: 'linear-gradient(135deg, #b8a06a 0%, #a58b52 100%)',
                        color: '#1f2023',
                        boxShadow: '0 4px 12px rgba(184,160,106,0.25)',
                      }}
                    >
                    ...
                    <div className="flex gap-2 flex-shrink-0">
                      <button
                        ...
                        style={{
                          background: 'linear-gradient(135deg, #b8a06a 0%, #a58b52 100%)',
                          color: '#1f2023',
                          boxShadow: '0 2px 8px rgba(184,160,106,0.25)',
                        }}
                        onMouseEnter={e => {
                          e.currentTarget.style.boxShadow = '0 4px 16px rgba(184,160,106,0.4)'
                          e.currentTarget.style.transform = 'translateY(-2px)'
                        }}
                        onMouseLeave={e => {
                          e.currentTarget.style.boxShadow = '0 2px 8px rgba(184,160,106,0.25)'
                          e.currentTarget.style.transform = 'translateY(0)'
                        }}
                      >
                        Aprobar
                ...
                <div className="px-5 pb-5">
                  ...
                  >
                    <div className="flex items-start gap-3 mb-4">
                      ...
                      <div>
                        <p className="font-body font-bold text-sm mb-1" style={{ color: '#1f2023' }}>
                          ¿Estás seguro de rechazar este usuario?
                        </p>
                        <p className="text-xs font-body" style={{ color: '#6f7377' }}>
                          Esta acción eliminará permanentemente la solicitud de <strong style={{ color: '#1f2023' }}>{u.nombre}</strong>. No se podrá deshacer.
                        </p>
                      </div>
                    </div>
              ...
              {isApproving && (
                <div className="px-5 pb-5">
                  <div
                    ...
                    style={{
                      background: 'rgba(184,160,106,0.04)',
                      border: '1.5px solid rgba(184,160,106,0.15)',
                    }}
                  >
                    {/* Selector de rol â€” solo Plan_pro */}
                    {isPro && (
                      <div>
                        ...
                        <div className="grid sm:grid-cols-2 gap-3">
                          {[
                            { val: 'general', label: 'Participante', desc: 'Solo observa y participa', icon: 'ðŸ‘¤' },
                            { val: 'jefe', label: 'Jefe de Área', desc: 'Gestiona su área', icon: 'â­' },
                          ].map(opt => {
                            ...
                            return (
                              <button
                                ...
                                style={{
                                  background: isActive ? 'rgba(184,160,106,0.1)' : '#fff',
                                  border: `1.5px solid ${isActive ? '#b8a06a' : '#dedbd4'}`,
                                  color: isActive ? '#8f7a45' : '#6f7377',
                                  boxShadow: isActive ? '0 2px 8px rgba(184,160,106,0.15)' : '0 1px 0 rgba(31,32,35,0.03)',
                                }}
                              >
                                <div className="flex items-center gap-3 mb-2">
                                  <span className="text-xl">{opt.icon}</span>
                                  <p className="font-body font-bold text-sm" style={{ color: isActive ? '#1f2023' : '#6f7377' }}>
                                    {opt.label}
                                  </p>
                                </div>
                                <p className="font-body text-[11px]" style={{ color: '#6f7377' }}>
                                  {opt.desc}
                                </p>
                              </button>
                            )
                    ...
                    {/* Selector de área â€” solo Plan_pro */}
                    {isPro && (
                      <div>
                        <p className="text-[11px] font-body font-bold uppercase tracking-[0.15em] mb-3 flex items-center gap-2"
                          style={{ color: '#8f7a45' }}>
                        ...
                        {areas.length === 0 ? (
                          ...
                          >
                            <div className="flex items-start gap-3">
                              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#b8a06a" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="flex-shrink-0 mt-0.5">
                                <circle cx="12" cy="12" r="10" />
                                <line x1="12" y1="8" x2="12" y2="12" />
                                <line x1="12" y1="16" x2="12.01" y2="16" />
                              </svg>
                              <div>
                                <p className="text-xs font-body font-semibold mb-1" style={{ color: '#1f2023' }}>
                                  No hay áreas disponibles
                                </p>
                                <p className="text-[10px] font-body" style={{ color: '#6f7377' }}>
                            ...
                            {areas.map(a => {
                              ...
                              return (
                                <button
                                  ...
                                  style={{
                                    background: isActive ? '#b8a06a' : '#fff',
                                    border: `1.5px solid ${isActive ? '#b8a06a' : '#dedbd4'}`,
                                    color: isActive ? '#1f2023' : '#6f7377',
                                  }}
                                >
                                  {a.nombre}
                                </button>
                    ...
                    {!isPro && (
                      ...
                      >
                        <p className="text-xs font-body flex items-start gap-2" style={{ color: '#6f7377' }}>
                          ...
                          <span>Al confirmar, el usuario quedará activo y podrá participar en todas las pronósticos de la empresa.</span>
                        </p>
                      </div>
                    )}
                      ...
                      <button
                        ...
                        style={{
                          background: approvingInProgress 
                            ? 'rgba(184,160,106,0.3)' 
                            : 'linear-gradient(135deg, #b8a06a 0%, #a58b52 100%)',
                          color: '#1f2023',
                          boxShadow: approvingInProgress ? 'none' : '0 2px 8px rgba(184,160,106,0.25)',
                        }}
                      >
                        {approvingInProgress && (
                          <span 
