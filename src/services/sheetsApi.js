...
const API_URL = 'https://script.google.com/macros/s/AKfycbz2X7NX7taipHGjkDmiBvWBql0QB4z4VZowYiVEbVXQBdW1_hdPuKwdNeAOrl-7_i6UqQ/exec'
  ...
  overlay.innerHTML = `
    ...
    <div style="text-align: center; color: #fff; max-width: 320px; padding: 1.5rem;">
      <div style="
        ...
        margin: 0 auto 1rem;
        display: flex; align-items: center; justify-content: center;">
        <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#b8a06a" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">
...
const predicciones = {
  ...
  // Ranking global: suma de puntos de TODAS las apuestas por participante.
  // Devuelve la misma forma que tabla(): { tabla, total, mi_posicion, esta_en_top, apuesta_titulo }
