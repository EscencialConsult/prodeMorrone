          ...
          {bet.partidos.slice(0,3).map(m=>{
            ...
            return(
              <div key={m.id} style={{display:'grid',gridTemplateColumns:'1fr auto 1fr',alignItems:'center',gap:'.6rem',padding:'.55rem .75rem',borderRadius:9,background:pred?'rgba(184,160,106,.05)':'rgba(32,33,36,.02)',border:pred?'1px solid rgba(184,160,106,.2)':'1px solid #dedbd4'}}>
                <span style={{fontWeight:500,fontSize:'.8rem',color:'#202124',overflow:'hidden',textOverflow:'ellipsis',whiteSpace:'nowrap'}}>{nombreLocal}</span>
                ...
                <span style={{fontWeight:500,fontSize:'.8rem',color:'#202124',textAlign:'right',overflow:'hidden',textOverflow:'ellipsis',whiteSpace:'nowrap'}}>{nombreVisitante}</span>
              </div>
            )
          })}
